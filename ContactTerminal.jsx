...
const Field = ({ id, label, type = "text", placeholder, options = null, value, onChange, isFocused, onFocus, onBlur }) => (
  <div className="relative mb-8 group">
    ...
    <label 
      htmlFor={id} 
      className={`block font-mono text-xs tracking-[0.2em] mb-2 transition-colors duration-300 ${
        isFocused ? "text-[#009FE3]" : "text-gray-600"
      }`}
    >
      {`> ${label}`}
    </label>
            ...
            {status === 'SUCCESS' ? (
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-green-500 font-mono text-xl tracking-widest mb-2">TRANSMISSION COMPLETE</h3>
                  <p className="text-white/50 font-mono text-sm">DATA PACKET RECEIVED. STANDBY FOR RESPONSE.</p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-2">
                ...
                <div className="mb-8 border-l-2 border-signal-blue pl-4">
                  ...
                  <p className="text-white/40 font-mono text-xs">
                    ENTER_CREDENTIALS_AND_MESSAGE_DATA
                  </p>
                </div>
                ...
                <Field 
                    ...
                    type="select"
                    options={[
                        { value: 'INQUIRY', label: 'PROJECT_INQUIRY' },
                        { value: 'SUPPORT', label: 'TECHNICAL_SUPPORT' },
                        { value: 'COLLAB', label: 'COLLABORATION' },
                        { value: 'OTHER', label: 'OTHER_DATA' }
                    ]}
                ...
                <div className="pt-4 relative">
                  ...
                  >
                    <span 
                      ...
                      data-text={status === 'SENDING' ? 'TRANSMITTING...' : 'EXECUTE_TRANSMISSION'}
                    >
