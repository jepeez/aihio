...
export function AV_logo3d(props) {
  ...
  useFrame((state, delta) => {
    ...
    const assembleStart = 3.2
    const assembleEndTime = 7.0 
    const interactionStartTime = 8.5
    ...
    if (isIntro) {
        ...
        if (!props.isMobile) {
            ...
            targetIntensity = Math.pow(rawTargetIntensity, 2.5) 
        }

        const isExploding = targetIntensity > intensityRef.current
        const lerpFactor = isExploding ? 0.2 : 0.05
